...
error.report = { durationMs: 12345, attempts: [{ attempt: 1, stage: "timeout", status: null, durationMs: 123, causeCode: "ETIMEDOUT", message: "secret-value" }, {}, {}], error: { stage: "network", name: "TypeError", causeCode: "ECONNRESET", causeErrno: -4077, causeSyscall: "read", causeHostname: "rtr.pbs.gov.tw" } };
...
assert.deepEqual(output.attemptDetails[0], { attempt: 1, stage: "timeout", status: null, durationMs: 123, causeCode: "ETIMEDOUT" });
