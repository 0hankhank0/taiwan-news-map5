...
module.exports = async (req, res) => {
  ...
  return sendJson(res, 200, {
    ...
    refresh: {
      ...
      consecutiveFailures: Number(refresh.consecutiveFailures || 0),
      lastAlertAt: refresh.lastAlertAt || "",
      dataStale: !refresh.lastSuccessAt || (Date.now() - Date.parse(refresh.lastSuccessAt || 0)) > 20 * 60 * 1000,
      persistentStoreHealthy: Boolean(cache.hasKv),
