(function initEventContentFilter(root, factory) {
  ...
  const CONCRETE_EVENT_PATTERN = /車禍|事故|追撞|翻車|壅塞|回堵|封路|封閉|交通管制|管制|改道|施工|故障車|掉落物|障礙物|淹水|積淹水|坍方|落石|土石流|停水|停電|停駛|停航|停運|火災|火警|爆炸|疏散|撤離|搶修|災害|公共安全|警戒|禁止通行|道路中斷|交通影響|影響交通|危險設施|有毒氣體|避難|停車管制|人潮管制|大規模影響|號誌|車道|匝道|交流道|排除|拖吊|救援|警察|消防|救護|緊急|拋錨|塞車|車多|單線|雙向|邊坡|closure|closed|accident|congestion|construction|flood|rockfall|debris/i;
